...
import {RegisterKeyService} from '../services/User/RegisterKeyService';
...
export function RegisterForm() {
    ...
    const handleSubmit: FormEventHandler = async (event: FormEvent) => {
        ...
        if (Object.keys(state).length === 0) {
            ...
            const service: RegisterKeyService = new RegisterKeyService(
                'https://127.0.0.1:5000/create-challenge-attestation',
                'https://127.0.0.1:5000/verify-challenge-attestation'
            );
    ...
    return(
        ...
        <div className="px-6 py-4">
            ...
            <form onSubmit={handleSubmit}>
                <div className="w-full mt-4">
                    <input name = "username" onChange = {handleInputChange} className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" type="text" placeholder="Username" aria-label="Username"/>
                </div>
        ...
        <div className="flex items-center justify-center py-4 text-center bg-gray-100 dark:bg-gray-700">
            ...
            <Link to="/" className="mx-2 text-sm font-bold text-blue-600 dark:text-blue-400 hover:text-blue-500">Login</Link>
